...
**你必须输出符合质量审查阶段 schema 的专业审查结论；工具只提供客观信号，不能替代你的 LLM 判断。**
...
### 可用工具信号：
```
compliance_checker：形式合规、结构完整和硬规则信号
claim_quality_analyzer：权利要求清楚性、简洁性和层级线索
support_verifier：权利要求与说明书支持关系线索
oa_predictor：潜在审查风险线索
```
